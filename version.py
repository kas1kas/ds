...
if __name__ == "__main__":
    ...
    # Define file paths
    python_files = ['wk.py', 'wk_plugin.py'] 
    html_files = ['templates_plugin/index.html', 'templates_plugin/calibration.html', 'templates_plugin/wifi.html', 'templates/index.html', 'templates/calibration.html']
